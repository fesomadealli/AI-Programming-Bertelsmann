...
class Gaussian():
    ...
    def calculate_stdev(self, sample=True):
        ...
        # recalculate and update mean
        new_mean = sum(self.data) / len(self.data)
        self.mean = new_mean
        sigma = 0
        for val in self.data:
            sigma += (val - self.mean) ** 2
    ...
    def read_data_file(self, file_name, sample=True):
        ...
        if sample:
            ...
            st_dev = False
        # update params for calculate_stdev()
        self.stdev = self.calculate_stdev(st_dev)
    ...
    def pdf(self, x):
        ...
        prob_density_func = (1.0 / (self.stdev * math.sqrt(2 * math.pi))) * math.exp(-0.5 * ((x - self.mean) / self.stdev) ** 2)
...
custom_gaussian = Gaussian()


# In[7]:


custom_gaussian.read_data_file('numbers.txt', sample=False)
# custom_gaussian.data
print("stdev (population): ", custom_gaussian.stdev)


# In[8]:


custom_gaussian.read_data_file('numbers.txt', sample=True)
# custom_gaussian.data
print("stdev (sample): ", custom_gaussian.stdev)
...
class TestGaussianClass(unittest.TestCase):
    ...
    def test_stdevcalculation(self):
        ...
        self.gaussian.read_data_file('numbers.txt', sample=False)
